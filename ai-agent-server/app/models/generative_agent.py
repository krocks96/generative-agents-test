...
"""
    ...
    def _compute_agent_summary(self) -> str:
        ...
        prompt = PromptTemplate.from_template(
            "Please summarize {name}'s feelings towards the protagonist"
            + "based on the following events without exaggeration."
            + "{related_memories}"
            + "\nPlease answer in the Japanese."
            + "\n\n要約: "
        )

        relevant_memories = self.memory.fetch_memories(f"{self.name}'s feeling")
